        ...
        <div className="flex min-h-screen flex-col mb-5 max-w-[900px] min-w-[500px]">
            ...
            <div className="flex flex-col mt-5 whitespace-nowrap">
                ...
                <div className="text-base  mt-3 mb-8">
                    <StatusPrice bidStatus={detailData && detailData.itemStatus } highestPrice={detailData && detailData.highestPrice} hopePrice={detailData && detailData.hopePrice} bidCount={detailData?.bidCount as number} awardPrice={detailData && detailData.awardPrice}/>
                </div>
