    ...
    return(
        <nav className="flex flex-row sm:flex-col sm:shadow-lg sm:w-52 sm:pt-8 sm:sticky sm:top-0 sm:h-screen bg-MAIN_COLOR sm:bg-white shadow-custom-top rounded-t-[20px] sm:rounded-none ">
            ...
            <ul className="flex-1 px-3 mt-3 sm:mt-10 sm:ml-5 flex flex-row sm:flex-col">
                <li className={`basis-1/5 sm:basis-0 grid justify-items-center sm:justify-start pt-4 sm:pt-0 ${menuTab === "home" ? clickStyle : ""}`}>
                ...
                <li className={`basis-1/5 sm:basis-0 grid justify-items-center sm:justify-start pt-4 sm:pt-0 ${menuTab === "search" ? clickStyle : ""}`}>
                ...
                <li className="basis-1/5 sm:basis-0 grid justify-items-center sm:justify-start">
                    <button 
                ...
                {subDrop && (
                <ul className={`absolute bottom-20 sm:static sm:bottom-0 py-5 sm:py-0 sm:animate-none ${subDrop ? "animate-slideUp" : "animate-slideDown" } pl-10 text-lg w-full backdrop-blur z-10 h-fit left-0 bg-DEEP_MAIN/30 sm:bg-white sm:bg-opacity-0 bg-opacity-10 sm:px-8 sm:grid sm:gap-y-3 whitespace-nowrap grid justify-items-start sm:justify-items-center sm:justify-start`}>               
                    <li className={menuTab === "의류" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("의류")} >- 의류</button></li>
                    <li className={menuTab === "신발" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("신발")} >- 신발</button></li>
                    <li className={menuTab === "악세사리" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("악세사리")} >- 악세사리</button></li>
                    <li className={menuTab === "가구" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("가구")} >- 가구</button></li>
                    <li className={menuTab === "전자제품" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("전자제품")} >- 전자제품</button></li>
                    <li className={menuTab === "앨범" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("앨범")} >- 앨범</button></li>
                    <li className={menuTab === "악기" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("악기")} >- 악기</button></li>
                    <li className={menuTab === "펫용품" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("펫용품")} >- 펫용품</button></li>
                    <li className={menuTab === "기타" ? clickStyle : ""}><button className="py-2 text-xl sm:pl-2 font-normal sm:text-sm hover:text-DEEP_MAIN" onClick={() => handleNavCategory("기타")} >- 기타</button></li>
                </ul>    
                )}
                <li className={`basis-1/5 sm:basis-0 grid justify-items-center sm:justify-start pt-4 sm:pt-5 ${menuTab === "soldItem" ? clickStyle : ""}`}>
                ...
                <li className={`basis-1/5 sm:basis-0 grid justify-items-center sm:justify-start pt-4 sm:pt-0 ${menuTab === "chatRoom" ? clickStyle + "sm:pt-4" : "sm:pt-4"}`}>
                    <Link href="/chat">
                ...
                <li className={`basis-1/5 sm:basis-0 grid justify-items-center sm:justify-start pt-4 sm:pt-0 ${menuTab === "alarm" ? clickStyle : ""}`}>
            ...
            <div className="flex flex-row justify-between sm:justify-start w-full items-center sm:sticky absolute top-0 py-2 sm:bottom-0 sm:shadow-custom-top bg-transparent backdrop-blur z-30">
                ...
                { mounted && isLogin.isLogin
                    ...
                    : <Link href="/login"><button className=" py-2 px-3 ml-5 hover:text-MAIN_COLOR text-sm sm:border-none border-2 border-MAIN_COLOR rounded-full  ">로그인</button></Link>
