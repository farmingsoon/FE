...
const Navbar = () => {
    const btnStyle = "flex flex-row items-center w-fit whitespace-nowrap "
    return(
        <nav className="flex flex-col shadow-lg w-52 pt-8">
            <h1 className="mb-5">FARMINGSOON</h1>
            <ul className="flex-1 px-3 grid gap-y-4 mb-20">
                ...
                <ul className="px-8 grid gap-y-3">               
            ...
            <button className="px-3 mb-5 "><Hamburger width={"25px"} height={"25px"}/></button>
        </nav>
    )
}
